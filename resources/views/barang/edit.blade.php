<x-app-layout>
        ...
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-gray-500 text-sm mt-1">
                    Perbarui data barang dan pengaturan ukuran di form berikut.
                </p>
            </div>
                ...
                <div class="grid gap-5 md:grid-cols-2">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <p class="text-xs text-gray-500 mb-2">
                            Perbarui daftar ukuran untuk barang ini. Setiap ukuran memiliki jumlah stok masing-masing.
                        </p>

                        @php
                            // jika ada old value (validasi gagal), pakai itu;
                            // kalau tidak, pakai data dari relasi size
                            $oldUkurans = old('ukuran', $barang->size->pluck('ukuran')->toArray() ?: ['']);
                            $oldJumlahs = old('jumlah', $barang->size->pluck('jumlah')->toArray() ?: ['']);
                        @endphp
                        ...
                        @if ($barang->gambar)
                            <div class="mb-2">
                                ...
                                <img src="{{ asset('storage/'.$barang->gambar) }}" alt="Gambar barang"
                                     class="h-24 rounded-md border border-gray-200">
                            </div>
                        @endif
    ...
    {{-- Script untuk tambah/hapus baris ukuran --}}
    <script>
